            ...
            <td>
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  ...
                  >
                  <a class="dropdown-item edit-transaction-camera-data" href="#" data-bs-toggle="modal"
                  data-bs-target="#editTransactionCameraModal"
                    ><i class="bx bx-edit me-1"></i> Edit</a
                  >
                  <a class="dropdown-item delete-transaction-camera-data" href="#" data-bs-toggle="modal"
                  data-bs-target="#deleteTransactionCameraModal"
