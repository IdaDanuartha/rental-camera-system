...
<x-search-bar>
    <ul class="navbar-nav flex-row align-items-center ms-auto">
        ...
        <li class="nav-item relative cursor-pointer" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart" aria-controls="offcanvasCart">
            <span class="rounded-circle bg-danger text-white position-absolute" style="right: 10px; top: 10px; padding: 1px 5px; font-size: 12px;">3</span>
...
<div class="row row-cols-1 row-cols-xl-4 row-cols-lg-3 row-cols-md-2 g-4 mb-5">
    @foreach ($products as $item)
        <div class="col product-card detail-product-data" data-bs-toggle="modal" data-bs-target="#detailProductModal">
            ...
            <img class="card-img-top" src="{{ asset("uploads/products/" . $item->productImages[0]->image) }}" alt="Card image cap" />
