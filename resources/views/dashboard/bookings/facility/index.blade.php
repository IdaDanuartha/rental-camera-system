...
@section('title', 'Transaction Facility Page')
...
<div class="card">
  <div class="d-flex justify-content-between align-items-center">
    <h5 class="card-header">Data Transaction Facility</h5>
    <a href="{{ route('bookings.facilities.create') }}" class="btn btn-primary me-3">Add Transaction</a>
  </div>
