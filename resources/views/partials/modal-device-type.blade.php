...
<div class="modal fade" id="createTypeModal" data-bs-backdrop="static" tabindex="-1">
  <div class="modal-dialog modal-lg">
    <form class="modal-content" action="{{ route('devices.types.store') }}" method="post">
      @csrf
      <div class="modal-header">
        <h5 class="modal-title" id="createTypeModalTitle">Create New Device Type</h5>
        <button
          type="button"
          class="btn-close"
...
<div class="modal fade" id="detailTypeModal" tabindex="-1">
  <div class="modal-dialog modal-lg">
    <form class="modal-content">      
      <div class="modal-header">
        <h5 class="modal-title" id="detailTypeModalTitle">Detail Device Type</h5>
        <button
          type="button"
          class="btn-close"
          data-bs-dismiss="modal"
...
<div class="modal fade" id="editTypeModal" data-bs-backdrop="static" tabindex="-1">
  <div class="modal-dialog modal-lg">
    <form class="modal-content" action="" id="edit_device_type_form" method="post">
      @csrf
      @method("PUT")      
      <div class="modal-header">
        <h5 class="modal-title" id="editTypeModalTitle">Edit Device Type</h5>
        <button
          type="button"
          class="btn-close"
          data-bs-dismiss="modal"
...
<div class="modal fade" id="deleteTypeModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="deleteTypeModalTitle">Delete Device Type</h5>
        <button
          type="button"
          class="btn-close"
          data-bs-dismiss="modal"
      ...
      <div class="modal-body">  
        <p>Force Deletion Confirmation: Are you sure you want to delete
          this device type? This action cannot be reversed and the force will
