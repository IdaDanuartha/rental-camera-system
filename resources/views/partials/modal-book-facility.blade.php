{{-- Detail Facility --}}
<div class="modal fade" id="detailFacilityModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
      <form class="modal-content">      
        <div class="modal-header">
          <h5 class="modal-title" id="detailFacilityModalTitle">Detail Facility</h5>
          <button
            type="button"
            class="btn-close"
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-md-6 col-12 mb-3">
                <div class="swiper facilityImage" id="detail_facility_images">
